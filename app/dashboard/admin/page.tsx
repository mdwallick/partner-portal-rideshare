  ...
  return (
    <div className="text-white p-6">
      ...
      <div className="flex justify-between items-center mb-8">
        <div>
          <h1 className="text-3xl font-bold text-white">Partner Administration</h1>
          <p className="text-gray-400">Manage partners assigned to your administration</p>
        </div>
        <Link
          ...
          <div className="p-6 text-center text-gray-400">
            {partners.length === 0 ? (
              <div>
                ...
                <p className="text-lg mb-2">No partners assigned yet</p>
                <p className="mb-4">You haven't been assigned to manage any partners</p>
                <Link
                  href="/dashboard/admin/partners/new"
              ...
              <div key={partner.id} className="p-6 hover:bg-gray-700 transition-colors">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <Link
                      href={`/dashboard/admin/partners/${partner.id}/users`}
