...
async function testAuth0Simple() {
  try {
    console.log("🔍 Simple Auth0 Management API Test")
    console.log("===================================")
    ...
    console.log(
      "Available methods:",
      Object.keys(managementClient).filter(key => typeof managementClient[key] === "object")
    )
    ...
    console.log("\n🎉 Test passed! Your Auth0 Management API is configured correctly.")
  } catch (error) {
